...
/datum/statpack/agile/hardy
	...
	stat_array = list(STATKEY_CON = 3, STATKEY_END = 3, STATKEY_STR = -2, STATKEY_SPD = -2)
...
/datum/statpack/agile/thug
	...
	stat_array = list(STATKEY_STR = 2, STATKEY_PER = 1, STATKEY_LCK = 1, STATKEY_CON = -1, STATKEY_END = -1, STATKEY_SPD = -1)

/datum/statpack/agile/wary
	name = "Wary"
	desc = "Eyes forward, ever and always. A careful course has always seen you through... so far."
	stat_array = list(STATKEY_PER = 3, STATKEY_INT = 3, STATKEY_STR = -2, STATKEY_CON = -2)
