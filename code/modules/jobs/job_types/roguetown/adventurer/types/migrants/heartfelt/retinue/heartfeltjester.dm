...
/datum/advclass/heartfelt/retinue/jester
	...
	outfit = /datum/outfit/job/heartfelt/retinue/jester
...
/datum/outfit/job/heartfelt/retinue/jester/pre_equip(mob/living/carbon/human/H)
	..()
	...
	if(!istype(H.getorganslot(ORGAN_SLOT_TONGUE), /obj/item/organ/tongue/wild_tongue))
		var/obj/item/organ/tongue/wild_tongue/wild = new
		wild.Insert(H, TRUE, FALSE)
