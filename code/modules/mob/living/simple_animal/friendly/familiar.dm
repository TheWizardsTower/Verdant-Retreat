...
/datum/status_effect/buff/familiar/burdened_coil
	id = "burdened_coil"
	effectedstats = list(STATKEY_STR = 1, STATKEY_END = 1, STATKEY_SPD = -1)
...
/datum/status_effect/buff/familiar/starseam
	id = "starseam"
	effectedstats = list(STATKEY_PER = 1, STATKEY_SPD = 1, STATKEY_STR = -1)
...
/datum/status_effect/buff/familiar/steady_spark
	id = "steady_spark"
	effectedstats = list(STATKEY_INT = 1, STATKEY_CON = 1, STATKEY_PER = -1)
...
/datum/status_effect/buff/familiar/subtle_slip
	id = "subtle_slip"
	effectedstats = list(STATKEY_SPD = 1, STATKEY_LCK = 1, STATKEY_STR = -1)
