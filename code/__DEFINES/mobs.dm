...
///The shock arrived through conductive liquid; it must not spread through water again.
#define SHOCK_CONDUCTED (1 << 4)
...
#define LIFEWORK_ALL (LIFEWORK_WOUNDS|LIFEWORK_REAGENTS|LIFEWORK_TEMP|LIFEWORK_ORGANS|LIFEWORK_FIRE_WATER|LIFEWORK_MISC)
